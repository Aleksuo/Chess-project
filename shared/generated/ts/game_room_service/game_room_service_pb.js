...
goog.exportSymbol('proto.game_room_service.GameState', null, global);
goog.exportSymbol('proto.game_room_service.GameState.GAME_STATE', null, global);
goog.exportSymbol('proto.game_room_service.GameState.TURN', null, global);
...
goog.exportSymbol('proto.game_room_service.RoomUpdateResponse', null, global);
goog.exportSymbol('proto.game_room_service.UPDATE_TYPE', null, global);
/**
 ...
 * @constructor
 */
proto.game_room_service.RoomUpdateResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.game_room_service.RoomUpdateResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.game_room_service.RoomUpdateResponse.displayName = 'proto.game_room_service.RoomUpdateResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.game_room_service.GameState = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.game_room_service.GameState, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.game_room_service.GameState.displayName = 'proto.game_room_service.GameState';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.game_room_service.RoomUpdateResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.game_room_service.RoomUpdateResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.game_room_service.RoomUpdateResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.game_room_service.RoomUpdateResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    updatetype: jspb.Message.getFieldWithDefault(msg, 1, 0),
    roomid: jspb.Message.getFieldWithDefault(msg, 2, ""),
    gamestate: (f = msg.getGamestate()) && proto.game_room_service.GameState.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.game_room_service.RoomUpdateResponse}
 */
proto.game_room_service.RoomUpdateResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.game_room_service.RoomUpdateResponse;
  return proto.game_room_service.RoomUpdateResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.game_room_service.RoomUpdateResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.game_room_service.RoomUpdateResponse}
 */
proto.game_room_service.RoomUpdateResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.game_room_service.UPDATE_TYPE} */ (reader.readEnum());
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.game_room_service.GameState;
      reader.readMessage(value,proto.game_room_service.GameState.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.game_room_service.RoomUpdateResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.game_room_service.RoomUpdateResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.game_room_service.RoomUpdateResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.game_room_service.RoomUpdateResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.game_room_service.GameState.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!proto.game_room_service.UPDATE_TYPE}
 */
proto.game_room_service.RoomUpdateResponse.prototype.getUpdatetype = function() {
  return /** @type {!proto.game_room_service.UPDATE_TYPE} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.game_room_service.UPDATE_TYPE} value
 * @return {!proto.game_room_service.RoomUpdateResponse} returns this
 */
proto.game_room_service.RoomUpdateResponse.prototype.setUpdatetype = function(value) {
 ...
 * @return {string}
 */
proto.game_room_service.RoomUpdateResponse.prototype.getRoomid = function() {
 ...
 * @return {!proto.game_room_service.RoomUpdateResponse} returns this
 */
proto.game_room_service.RoomUpdateResponse.prototype.setRoomid = function(value) {
 ...
 * @return {!proto.game_room_service.RoomUpdateResponse} returns this
 */
proto.game_room_service.RoomUpdateResponse.prototype.clearRoomid = function() {
 ...
 * @return {boolean}
 */
proto.game_room_service.RoomUpdateResponse.prototype.hasRoomid = function() {
 ...
 * @return {?proto.game_room_service.GameState}
 */
proto.game_room_service.RoomUpdateResponse.prototype.getGamestate = function() {
  return /** @type{?proto.game_room_service.GameState} */ (
    jspb.Message.getWrapperField(this, proto.game_room_service.GameState, 3));
};


/**
 * @param {?proto.game_room_service.GameState|undefined} value
 * @return {!proto.game_room_service.RoomUpdateResponse} returns this
*/
proto.game_room_service.RoomUpdateResponse.prototype.setGamestate = function(value) {
 ...
 * @return {!proto.game_room_service.RoomUpdateResponse} returns this
 */
proto.game_room_service.RoomUpdateResponse.prototype.clearGamestate = function() {
 ...
 * @return {boolean}
 */
proto.game_room_service.RoomUpdateResponse.prototype.hasGamestate = function() {
 ...
 * @return {!Object}
 */
proto.game_room_service.GameState.prototype.toObject = function(opt_includeInstance) {
  return proto.game_room_service.GameState.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.game_room_service.GameState} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.game_room_service.GameState.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.game_room_service.GameState}
 */
proto.game_room_service.GameState.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.game_room_service.GameState;
  return proto.game_room_service.GameState.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.game_room_service.GameState} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.game_room_service.GameState}
 */
proto.game_room_service.GameState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 2:
      var value = /** @type {!proto.game_room_service.GameState.GAME_STATE} */ (reader.readEnum());
      msg.setGamestate(value);
      break;
    case 3:
      var value = /** @type {!proto.game_room_service.GameState.TURN} */ (reader.readEnum());
 ...
 * @return {!Uint8Array}
 */
proto.game_room_service.GameState.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.game_room_service.GameState.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.game_room_service.GameState} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.game_room_service.GameState.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGamestate();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 * @enum {number}
 */
proto.game_room_service.GameState.GAME_STATE = {
  NOT_STARTED: 0,
  ONGOING: 1,
  FINISHED: 2
};
 ...
 * @enum {number}
 */
proto.game_room_service.GameState.TURN = {
  WHITE: 0,
  BLACK: 1
};
 ...
 * @return {!proto.game_room_service.GameState.GAME_STATE}
 */
proto.game_room_service.GameState.prototype.getGamestate = function() {
  return /** @type {!proto.game_room_service.GameState.GAME_STATE} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/**
 * @param {!proto.game_room_service.GameState.GAME_STATE} value
 * @return {!proto.game_room_service.GameState} returns this
 */
proto.game_room_service.GameState.prototype.setGamestate = function(value) {
 ...
 * @return {!proto.game_room_service.GameState.TURN}
 */
proto.game_room_service.GameState.prototype.getCurrentturn = function() {
  return /** @type {!proto.game_room_service.GameState.TURN} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.game_room_service.GameState.TURN} value
 * @return {!proto.game_room_service.GameState} returns this
 */
proto.game_room_service.GameState.prototype.setCurrentturn = function(value) {
 ...
 */
proto.game_room_service.GameState.prototype.getChessgame = function() {
 ...
 * @return {!proto.game_room_service.GameState} returns this
*/
proto.game_room_service.GameState.prototype.setChessgame = function(value) {
 ...
 * @return {!proto.game_room_service.GameState} returns this
 */
proto.game_room_service.GameState.prototype.clearChessgame = function() {
 ...
 * @return {boolean}
 */
proto.game_room_service.GameState.prototype.hasChessgame = function() {
 ...
 * @enum {number}
 */
proto.game_room_service.UPDATE_TYPE = {
  IN_MATCHMAKING: 0,
  ROOM_JOINED: 1,
