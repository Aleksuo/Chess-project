...
func (c *testServiceClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/test_service.TestService/hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTestServiceServer) Hello(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _TestService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test_service.TestService/hello",
	}
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "test_service/test_service.proto",
}
